      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="category-banner__item border-radius-10 mb-5">
            <img loading="lazy" class="h-auto" src="{{ asset('uploads/categories') }}/{{ $Mcategory->image }}"
              width="390" height="365" alt="{{ $Mcategory->name }}" />
            <div class="category-banner__item-mark">
              @if($Mcategory->min_price > 0)
              Starting at ${{ number_format($Mcategory->min_price, 2) }}
              @else
              Price on request
              @endif
            </div>
            <div class="category-banner__item-content">
              <h3 class="mb-0">{{ $Mcategory->name }}</h3>
              <a href="{{ route('shop.index', ['categories'=>$Mcategory->id]) }}"
      ...
      <div class="row">
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
            ...
            <div class="pc__info position-relative">
              <h6 class="pc__title"><a href="{{ route('shop.product.details', ['product_slug'=>$fproduct->slug]) }}">{{
                  $fproduct->name }}</a></h6>
