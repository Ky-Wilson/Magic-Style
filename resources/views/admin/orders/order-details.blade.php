...
<div class="main-content-inner">
    <div class="main-content-wrap">
        ...
        <div class="wg-box mt-5">
            ...
            @php
            $isFinalStatus = in_array($order->status, ['delivered', 'canceled']);
            @endphp
            ...
            <form action="{{ route('admin.update_order_status') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="select">
                            <select name="order_status" id="order_status" {{ $isFinalStatus ? 'disabled' : '' }}>
                    ...
                    <div class="col-md-3">
                        <button type="submit"
                            class="btn tf-button w200 {{ $isFinalStatus ? 'btn-secondary' : 'btn-primary' }}" {{
                            $isFinalStatus ? 'disabled' : '' }}>
                            {{ $isFinalStatus ? 'Status Final' : 'Update status' }}
                        </button>
                    </div>
                </div>
            </form>
            ...
            <div class="alert alert-info mt-3">
                <i class="icon-info"></i>
                Cette commande a un statut final et ne peut plus être modifiée.
            </div>
            @endif
        </div>
    </div>
