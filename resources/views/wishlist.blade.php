                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <form method="POST" action="{{ route('wishlist.item.remove', ['rowid' => $item->rowId]) }}" id="delete-form-{{ $item->id }}">
                                            @csrf
                                            @method('DELETE')
                                            <a href="javascript:void(0)" class="remove-cart" onclick="document.getElementById('delete-form-{{ $item->id }}').submit();">
