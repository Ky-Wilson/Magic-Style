                ...
                <li class="list-item">
                  <span class="menu-link py-1">
                    <input type="checkbox" name="brand" value="{{$brand->id}}" id="brand-{{$brand->id}}"
                      class="chk-brand" @if(in_array($brand->id, explode(',', $f_brands))) checked= "checked" @endif>
        ...
        <div class="accordion-item mb-4">
          ...
          <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
            ...
            <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="1"
              data-slider-max="150000" data-slider-step="100" data-slider-value="[{{ $min_price }},{{ $max_price }}]"
              data-currency="$" />
      ...
      <div class="swiper-container js-swiper-slider slideshow slideshow_small slideshow_split" data-settings='{
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
              <div class="slide-split_text position-relative d-flex align-items-center"
                style="background-color: #f8e8e3;">
                <div class="slideshow-text container p-3 p-xl-5">
                  <h2
                    class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                    New <br /><strong>COLLECTION</strong></h2>
                  <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Discover our latest arrivals
                    featuring premium bodysuits, elegant dresses, and statement pieces that define your unique style.
                  </p>
                </div>
              </div>
              <div class="slide-split_media position-relative">
                <div class="slideshow-bg" style="background-color: #f8e8e3;">
                  <img loading="lazy" src="{{ asset('assets/images/shop/Cat2_collant.png') }}" width="630" height="450"
                    alt="New women's collection" class="slideshow-bg__img object-fit-cover" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="swiper-slide">
            <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
              <div class="slide-split_text position-relative d-flex align-items-center"
                style="background-color: #e6d7c8;">
                <div class="slideshow-text container p-3 p-xl-5">
                  <h2
                    class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                    Bags & <br /><strong>SHOES</strong></h2>
                  <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Complete your look with our curated
                    selection of handbags, clutches, heels, and boots. Quality craftsmanship meets modern design.</p>
                </div>
              </div>
              <div class="slide-split_media position-relative">
                <div class="slideshow-bg" style="background-color: #e6d7c8;">
                  <img loading="lazy" src="{{ asset('assets/images/shop/Cat3_sac.png') }}" width="630" height="450"
                    alt="Women's bags and shoes collection" class="slideshow-bg__img object-fit-cover" />
                </div>
              </div>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
              <div class="slide-split_text position-relative d-flex align-items-center"
                style="background-color: #d4c4b0;">
                <div class="slideshow-text container p-3 p-xl-5">
                  <h2
                    class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                    Sale <br /><strong>UP TO 50%</strong></h2>
                  <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Don't miss our seasonal sale! Save up
                    to 50% on selected dresses, tops, bottoms, and accessories. Limited time offer.</p>
                </div>
              </div>
              <div class="slide-split_media position-relative">
                <div class="slideshow-bg" style="background-color: #d4c4b0;">
                  <img loading="lazy" src="{{ asset('assets/images/shop/Cat1_spencer.png') }}"
                    alt="Women's fashion sale" class="slideshow-bg__img object-fit-cover" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="d-flex justify-content-between mb-4 pb-md-2">
        ...
        <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
          <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Page Size"
            id="pagesize" name="size" style="margin-right: 20px">
          ...
          <div class="product-card mb-3 mb-md-4 mb-xxl-5">
            <div class="pc__img-wrapper">
              <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide">
                    ...
                    <a href="{{route('shop.product.details', ['product_slug'=> $product->slug])}}"><img loading="lazy"
                        src="{{ asset('uploads/products/') }}/{{ $img}}" width="330" height="400"
                        alt="{{ $product->name }}" class="pc__img"></a>
                    @endforeach
                  </div>
                </div>
              ...
              <a href="{{ route('cart.index') }}"
                class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase btn-warning mb-3">Go
                to Cart</a>
              @else
            ...
            <div class="pc__info position-relative">
              ...
              <h6 class="pc__title"><a href="{{route('shop.product.details', ['product_slug'=> $product->slug])}}">{{
                  $product->name }}</a></h6>
...
<script>
  $(document).ready(function() {
            ...
            $("input[name='brand']").on("change", function() {
                ...
                $('#page').val(1); // Reset to first page when changing brands
                $('#frmfilter').submit();
            });
            ...
            $("input[name='categories']").on("change", function() {
                ...
                $('#page').val(1); // Reset to first page when changing categories
                $('#frmfilter').submit();
            });
            ...
            $('.price-range-slider').on('change', function() {
                ...
                $('#hdnMinPrice').val(values[0]);
                $('#hdnMaxPrice').val(values[1]);
                $('#page').val(1); // Reset to first page when changing price range
               setTimeout(function() {
                    $('#frmfilter').submit();
                }, 1000); // Delay to allow slider to finish moving
            });
