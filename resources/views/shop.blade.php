              ...
              <div class="search-field multi-select accordion-body px-0 pb-0">
               <ul class="list list-inline mb-0 brand-list">
                    @foreach($brands as $brand)
                      <li class="list-item">
                        <span class="menu-link py-1">
                          <input type="checkbox" name="brand" value="{{$brand->id}}" id="brand-{{$brand->id}}" class="chk-brand"  @if(in_array($brand->id, explode(',', $f_brands))) checked= "checked" @endif>
    ...
    <div class="accordion-item mb-4">
        ...
        <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
            ...
            <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="1"
                data-slider-max="150000" data-slider-step="100" data-slider-value="[{{ $min_price }},{{ $max_price }}]" data-currency="$" />
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                   ...
                   <div class="swiper-slide">
                    ...
                    <div class="swiper-slide">
                        @foreach(explode(",", $product->images) as $img)
                            <a href="{{route('shop.product.details', ['product_slug'=> $product->slug])}}"><img loading="lazy" src="{{ asset('uploads/products/') }}/{{ $img}}" width="330" height="400" alt="{{ $product->name }}" class="pc__img"></a>
                        @endforeach
                    </div>
                  </div>
                ...
                <input type="hidden" name="price" value="{{ $product->sale_price ? $product->sale_price : $product->regular_price}}">
                    <button type="submit" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase" data-aside="cartDrawer" title="Add To Cart">Add To Cart</button>
                </form>
                @endif
            </div>
